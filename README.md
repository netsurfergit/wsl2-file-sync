...
A PowerShell script that syncs git-tracked changes from a Windows repository into a WSL2 distro in real time. Designed for developers who edit code in a Windows IDE but run and test inside WSL2.
